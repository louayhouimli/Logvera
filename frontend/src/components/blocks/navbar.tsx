    ...
    dropdownItems: [
      {
        ...
        description:
          "Logvera is built on the habits that make the best product teams successful",
      },
      {
        title: "Resource Allocation",
        href: "/#resource-allocation",
        description: "Logvera your resource allocation and execution",
      },
    ],
  },
      ...
      <div className="flex items-center justify-between px-6 py-3">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          <div className="flex flex-row items-center space-x-1">
            ...
            />
            <h1 className="text-foreground max-w-160 gap-x-2 text-2xl tracking-tight xl:whitespace-nowrap">
              Logvera
            </h1>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2.5">
          ...
          {isLoading ? (
            <Skeleton className="bg-muted/50 h-8 w-24 animate-pulse rounded-md" />
          ) : !user ? (
          ...
          <a
            href="https://github.com/louayhouimli/logvera"
            target="_blank"
