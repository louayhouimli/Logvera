...
const items = [
  {
    quote: "We're misusing Logvera as a CRM and it still works!",
    author: "Amy Chase",
    role: "PM",
  ...
  {
    quote: "I was able to replace 80% of my team with Logvera bots.",
    author: "Jonas Kotara",
    role: "Lead Engineer",
    company: "Mercury Finance",
        ...
        <div className="container">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-md leading-snug">
              Logvera is built on the habits that make the best product teams
