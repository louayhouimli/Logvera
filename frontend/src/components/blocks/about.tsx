    ...
    <section className="container mt-10 flex max-w-5xl flex-col-reverse gap-8 md:mt-14 md:gap-14 lg:mt-20 lg:flex-row lg:items-end">
      ...
      <div className="flex flex-col gap-8 lg:gap-16 xl:gap-20">
        ...
        <TextSection
          title="The team"
          paragraphs={[
            "We started building Logvera in 2019 and launched in 2022. Every endpoint has been designed from the ground up — with no technical debt or legacy systems. We are purpose-built to power project management innovation for the next hundred years.",
